...
# ponytail: allowlist keeps site/data.json to fields app.js actually reads (verified via grep);
# data/products.json keeps every field for archive.py + future extract.py classification.
python3 -c "
import json
